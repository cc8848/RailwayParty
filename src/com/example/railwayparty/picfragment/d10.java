...
public class d10 extends Fragment implements OnClickListener {
	...
	private void GetHeadPic() {
		...
		try {
			...
			imageLoader.DisplayImage(R.drawable.twoanddo, str_url, getActivity(), image, 0);
		} catch (Exception e) {
			// TODO: handle exception
		} catch (OutOfMemoryError e) {
			// TODO: handle exception
	...
	public void onResume() {
		...
		if (view != null) {
			try {
				...
				userPhoto = PreUserInfo.getString("d" + 9, "");
				url = PreUserInfo.getString("d_pic"+9, "");

				imageLoader = new ImageLoaderForHeadimg(getActivity());if (userPhoto.equals("")) {
					image.setImageResource(R.drawable.twoanddo);
				} else {
