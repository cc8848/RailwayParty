...
public class b10 extends Fragment implements OnClickListener {
	...
	private void GetHeadPic() {
		...
		try {
			...
			imageLoader.DisplayImage(R.drawable.buidld, str_url, getActivity(), image, 0);
		} catch (Exception e) {
			// TODO: handle exception
		} catch (OutOfMemoryError e) {
			// TODO: handle exception
	...
	public void onResume() {
		...
		if (view != null) {
			try {
				...
				userPhoto = PreUserInfo.getString("b" + 9, "");
				url = PreUserInfo.getString("b_pic" + 9, "");

				imageLoader = new ImageLoaderForHeadimg(getActivity());if (userPhoto.equals("")) {
					image.setImageResource(R.drawable.buidld);
				} else {
