...
public class p7 extends Fragment implements OnClickListener {
	...
	private void GetHeadPic() {
		...
		try {
			...
			imageLoader.DisplayImage(R.drawable.zhibu_top, str_url, getActivity(), image, 0);
		} catch (Exception e) {
			// TODO: handle exception
		} catch (OutOfMemoryError e) {
			// TODO: handle exception
	...
	public void onResume() {
		...
		if (view != null) {
			try {
				...
				userPhoto = PreUserInfo.getString("p" + 6, "");
				url = PreUserInfo.getString("p_pic"+6, "");

				imageLoader = new ImageLoaderForHeadimg(getActivity());imageLoader = new ImageLoaderForHeadimg(getActivity());if (userPhoto.equals("")) {
					image.setImageResource(R.drawable.zhibu_top);
				} else {
