...
public class p9 extends Fragment implements OnClickListener {
	...
	public void onResume() {
		...
		if (view != null) {
			try {
				...
				userPhoto = PreUserInfo.getString("p" + 8, "");
				url = PreUserInfo.getString("p_pic" + 8, "");

				imageLoader = new ImageLoaderForHeadimg(getActivity());
				if (userPhoto.equals("")) {
