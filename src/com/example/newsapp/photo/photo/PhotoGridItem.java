...
public class PhotoGridItem extends RelativeLayout implements Checkable {
	...
	public PhotoGridItem(Context context, AttributeSet attrs, int defStyle) {
		...
		mContext = context;
		LayoutInflater.from(mContext).inflate(R.layout.wuxc_list_album_gridview_item, this);
	...
	public void setChecked(boolean checked) {
		...
		mSelect.setImageDrawable(checked ? getResources().getDrawable(R.drawable.image_selected_icon)
				: getResources().getDrawable(R.drawable.image_unselected_icon));
