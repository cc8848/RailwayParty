...
public class Flag3Adapter extends ArrayAdapter<Flag3Model> {
	...
	public Flag3Adapter(Activity activity, List<Flag3Model> imageAndTexts, ListView listView) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (rowView == null) {
			...
			viewCache = (Flag3Cache) rowView.getTag();
		}
