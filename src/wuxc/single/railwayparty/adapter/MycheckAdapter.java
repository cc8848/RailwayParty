...
public class MycheckAdapter extends ArrayAdapter<MycheckModel> implements OnClickListener {

	public MycheckAdapter(Activity activity, List<MycheckModel> imageAndTexts, ListView listView) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		MycheckModel imageAndText = getItem(position);
