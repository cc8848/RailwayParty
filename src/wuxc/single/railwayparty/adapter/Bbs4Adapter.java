...
import wuxc.single.railwayparty.cache.Bbs4Cache;
...
public class Bbs4Adapter extends ArrayAdapter<Bbs4Model> implements OnClickListener {
	...
	public Bbs4Adapter(Activity activity, List<Bbs4Model> imageAndTexts, ListView listView) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Bbs4Model imageAndText = getItem(position);
		...
		if (rowView == null) {
			...
			rowView = inflater.inflate(R.layout.wuxc_item_bbs_4, null);
			viewCache = new Bbs4Cache(rowView);
			rowView.setTag(viewCache);
		} else {
			viewCache = (Bbs4Cache) rowView.getTag();
		}
