...
import wuxc.single.railwayparty.cache.PartyRuleCache;
...
public class PartyRuleAdapter extends ArrayAdapter<PartyRuleModel> implements OnClickListener {
	...
	public PartyRuleAdapter(Activity activity, List<PartyRuleModel> imageAndTexts, ListView listView) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		PartyRuleModel imageAndText = getItem(position);

		// Inflate the views from XML
		View rowView = convertView;

		PartyRuleCache viewCache;
		if (rowView == null) {
			LayoutInflater inflater = activity.getLayoutInflater();
			rowView = inflater.inflate(R.layout.wuxc_item_party_rule, null);
			viewCache = new PartyRuleCache(rowView);
			rowView.setTag(viewCache);
		} else {
			viewCache = (PartyRuleCache) rowView.getTag();
		}
