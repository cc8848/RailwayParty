...
public class Clean1Adapter extends ArrayAdapter<Clean1Model> implements OnClickListener {
	...
	public Clean1Adapter(Activity activity, List<Clean1Model> imageAndTexts, ListView listView, Callback callback) {
...
@Override
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Clean1Model imageAndText = getItem(position);

		// Inflate the views from XML
		View rowView = convertView;

		Clean1Cache viewCache;
		if (true) {
			LayoutInflater inflater = activity.getLayoutInflater();
			rowView = inflater.inflate(R.layout.wuxc_item_clean_1, null);
			viewCache = new Clean1Cache(rowView);
			rowView.setTag(viewCache);
		} else {
			viewCache = (Clean1Cache) rowView.getTag();
		}
