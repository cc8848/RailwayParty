...
import wuxc.single.railwayparty.cache.VotePersonCache;
...
public class VotePersonAdapter extends ArrayAdapter<VotePersonModel> {
	...
	public VotePersonAdapter(Activity activity, List<VotePersonModel> imageAndTexts, ListView listView) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (true) {
			...
			viewCache = new VotePersonCache(rowView);
			rowView.setTag(viewCache);
		} else {
			viewCache = (VotePersonCache) rowView.getTag();
		}
