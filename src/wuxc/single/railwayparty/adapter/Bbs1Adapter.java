...
import wuxc.single.railwayparty.cache.Bbs1Cache;
import wuxc.single.railwayparty.internet.URLcontainer;
import wuxc.single.railwayparty.model.Bbs1Model;
import wuxc.single.railwayparty.start.ImageLoader120;

public class Bbs1Adapter extends ArrayAdapter<Bbs1Model> implements OnClickListener {
	...
	public Bbs1Adapter(Activity activity, List<Bbs1Model> imageAndTexts, ListView listView, Callback callback) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Bbs1Model imageAndText = getItem(position);
		try {
			...
			if (!imageAndText.getImage1().equals("")) {
				...
				LinearLayout.LayoutParams LayoutParams2 = (android.widget.LinearLayout.LayoutParams) viewCache
						.getimage_1().getLayoutParams();
			...
			// TODO: handle exception
			Log.e("Exception", "Exception of getview");
		}
		return parent;
	}
