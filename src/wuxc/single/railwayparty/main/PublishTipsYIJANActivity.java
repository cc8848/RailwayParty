...
public class PublishTipsYIJANActivity extends FragmentActivity implements OnClickListener {
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
				if (position == (photoList.size())) {
					menuWindow = new SelectPicPopupWindow(PublishTipsYIJANActivity.this, itemsOnClick);
					menuWindow.showAtLocation(PublishTipsYIJANActivity.this.findViewById(R.id.uploadPictureLayout),
							Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0); // 设置layout在PopupWindow中显示的位置
				} else {
					Intent intent = new Intent(PublishTipsYIJANActivity.this, ViewPagerDeleteActivity.class);
		...
		public void onClick(View v) {
			...
			case R.id.btn_take_photo: {
				...
				if (status.equals(Environment.MEDIA_MOUNTED)) {
					...
					Toast.makeText(PublishTipsYIJANActivity.this, "没有SD卡", Toast.LENGTH_LONG).show();
				}
				break;
			}
	...
	protected void doPickPhotoFromGallery() {
		try {
			...
			final Intent intent = new Intent(PublishTipsYIJANActivity.this, PhotoAlbumActivity.class);
