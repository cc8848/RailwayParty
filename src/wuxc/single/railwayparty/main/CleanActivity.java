...
public class CleanActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wuxc_activity_clean);
	...
	private void initfragment() {
		// TODO Auto-generated method stub
		Fragments.add(new CleanFragment1());
		Fragments.add(new CleanFragment2());
		Fragments.add(new CleanFragment3());
		Fragments.add(new CleanFragment4());
	...
	public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			case 3:
				...
				text_line_4.setBackgroundColor(Color.parseColor("#ffffff"));
				image_edit.setVisibility(View.GONE);
				break;
			default:
				break;
	...
	private void clearcolor() {
		...
		text_4.setTextColor(Color.parseColor("#50ffffff"));
	...
	private void initview() {
		...
		text_line_4 = (TextView) findViewById(R.id.text_line_4);
