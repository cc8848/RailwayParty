...
public class PartyRewardFragment extends Fragment implements OnTouchListener, OnClickListener, OnItemClickListener {
	...
	private int[] headimg = { R.drawable.cheng, R.drawable.jiang, R.drawable.cheng, R.drawable.jiang, R.drawable.jiang,
			R.drawable.cheng, R.drawable.cheng, R.drawable.jiang, R.drawable.jiang, R.drawable.jiang,
			R.drawable.jiang };
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		// if (position == 1) {
		// Intent intent = new Intent();
		// intent.setClass(getActivity(), PartyRuleRewardActivity.class);
		// startActivity(intent);
		// }
	...
	private void getdatalist(int arg) {
		...
		try {
			...
			for (int i = 0; i < 10; i++) {
				...
				listinfo.setTitle("关于表彰2016年先进基层党组织、优秀党务工作者的决定");
