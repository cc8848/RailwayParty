...
public class DisciplinaryActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wuxc_activity_disciplinary);
	...
	private void initfragment() {
		// TODO Auto-generated method stub
		Fragments.add(new PartyRuleFragment());
