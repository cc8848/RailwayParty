...
public class PartyManageActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wuxc_activity_party_manage);
	...
	private void initfragment() {
		// TODO Auto-generated method stub
		Fragments.add(new PartyCheckFragment());
		Fragments.add(new PartyRewardFragment());
		Fragments.add(new PartyPublicFragment());
