...
public class TipsFragment extends Fragment implements OnTouchListener, OnClickListener, OnItemClickListener {
	...
	protected void go() {
		ListData.setPadding(0, -100, 0, 0);
		mAdapter = new TipsAdapter(getActivity(), list, ListData);
