...
public class MemberFragment2 extends Fragment implements OnTouchListener, OnClickListener, OnItemClickListener {
	...
	private void GetData() {
		...
		ArrayValues.add(new BasicNameValuePair("chn", "whzn"));chn="whzn";
		ArrayValues.add(new BasicNameValuePair("curPage", "" + curPage));
		ArrayValues.add(new BasicNameValuePair("pageSize", "" + pageSize));
