...
public class CleanFragment4 extends Fragment implements OnTouchListener, OnClickListener, OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		// if (position == 1) {
		// Intent intent = new Intent();
		// intent.setClass(getActivity(), PartyRuleClean4Activity.class);
		// startActivity(intent);
		// }
		...
		Bundle bundle = new Bundle();
		bundle.putInt("source", R.drawable.detail12);
		bundle.putInt("height", 1633);
