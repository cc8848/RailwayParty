...
public class MemberActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wuxc_activity_member);
	...
	private void initfragment() {
		// TODO Auto-generated method stub
		Fragments.add(new MemberFragment1());
		Fragments.add(new MemberFragment2());
		Fragments.add(new MemberFragment3());
		Fragments.add(new MemberFragment4());
