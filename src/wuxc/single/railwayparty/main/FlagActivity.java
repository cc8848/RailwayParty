...
public class FlagActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wuxc_activity_flag);
	...
	private void initfragment() {
		// TODO Auto-generated method stub
		Fragments.add(new FlagFragment1());
		Fragments.add(new FlagFragment2());
		Fragments.add(new FlagFragment3());
