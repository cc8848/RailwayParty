...
public class MessageDetailActivity extends Activity implements OnClickListener, OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new Thread(new Runnable() { // 开启线程上传文件
			...
			public void run() {
				String DueData = "";
				DueData = HttpGetData.GetData("api/console/systemMessage/changeToRead", ArrayValues);
