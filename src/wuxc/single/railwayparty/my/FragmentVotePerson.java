...
import wuxc.single.railwayparty.adapter.VotePersonAdapter;
import wuxc.single.railwayparty.internet.HttpGetData;
import wuxc.single.railwayparty.model.Bbs1Model;
import wuxc.single.railwayparty.model.VotePersonModel;

public class FragmentVotePerson extends Fragment implements OnTouchListener, OnClickListener, OnItemClickListener {
	private ListView ListData;
	List<VotePersonModel> list = new ArrayList<VotePersonModel>();
	private static VotePersonAdapter mAdapter;
...
//				Toast.makeText(getActivity(), "数据格式校验失败", Toast.LENGTH_SHORT).show();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		if (null != view) {
			...
			view = inflater.inflate(R.layout.wuxc_fragment_vote_person, container, false);
			initview(view);
			setonclicklistener();
			setheadtextview();
	...
	private void GetData() {
		...
		ArrayValues.add(new BasicNameValuePair("classify", "peopleVote"));
		// chn = "dyq";''
		ArrayValues.add(new BasicNameValuePair("curPage", "" + curPage));
		ArrayValues.add(new BasicNameValuePair("pageSize", "" + pageSize));
	...
	protected void go() {
		ListData.setPadding(0, -100, 0, 0);
		mAdapter = new VotePersonAdapter(getActivity(), list, ListData);
