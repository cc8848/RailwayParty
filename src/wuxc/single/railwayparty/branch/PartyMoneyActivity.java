...
public class PartyMoneyActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wuxc_activity_party_money);
	...
	private void initfragment() {
		// TODO Auto-generated method stub
		Fragments.add(new FragmentPartyMoneyLet());
		Fragments.add(new FragmentSendMoney());
