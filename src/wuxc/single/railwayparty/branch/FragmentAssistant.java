...
public class FragmentAssistant extends Fragment implements OnTouchListener, OnClickListener, OnItemClickListener {
...
//		Toast.makeText(getActivity(), "点击第" + position + "条" + "item", Toast.LENGTH_SHORT).show();
	...
	protected void go() {
		ListData.setPadding(0, -100, 0, 0);
		mAdapter = new AssistantAdapter(getActivity(), list, ListData);
