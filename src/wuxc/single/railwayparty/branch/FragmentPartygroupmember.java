...
public class FragmentPartygroupmember extends Fragment
	...
	private void GetData() {
		...
		ArrayValues.add(new BasicNameValuePair("deptId", LoginId));
		// chn = "dqlh";
		ArrayValues.add(new BasicNameValuePair("curPage", "" + curPage));
		ArrayValues.add(new BasicNameValuePair("pageSize", "" + pageSize));
		...
		new Thread(new Runnable() { // 开启线程上传文件
			...
			public void run() {
				String DueData = "";
				DueData = HttpGetData.GetData("api/user/getDeptUser", ArrayValues);
	...
	private void ReadTicket() {
		...
		LoginId = PreUserInfo.getString("deptId", "");
	}
	...
	protected void go() {
		ListData.setPadding(0, -100, 0, 0);
		mAdapter = new MemberAdapter(getActivity(), list, ListData);
