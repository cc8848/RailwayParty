...
public class SearchAdapter extends ArrayAdapter<SearchModel> implements OnClickListener {
	...
	public SearchAdapter(Activity activity, List<SearchModel> imageAndTexts, ListView listView, Callback callback) {
